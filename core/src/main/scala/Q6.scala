...
case class LINEITEMRecordQ6(val L_QUANTITY: Double, val L_EXTENDEDPRICE: Double, val L_DISCOUNT: Double, val L_SHIPDATE: Int)
object Q6 extends LegoRunner {
  ...
  def main() = 
  {
    ...
    val x2 = new Array[LINEITEMRecordQ6](x1)
